    ...
    $("#bsubmit").click(
        function(e){
            ...
            if($("#firstanswer1")[0].checked == true){
                $("#alert1").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la a ha sido incorrecta. <a href='mathfirstclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong></h4>");
           ...
           if($("#firstanswer2")[0].checked == true){
                ...
                $("#alert2").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la a ha sido incorrecta. <a href='mathfirstclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
            ...
            if($("#firstanswer3")[0].checked == true){
                $("#alert3").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la a ha sido incorrecta. <a href='mathfirstclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
