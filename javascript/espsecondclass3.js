var get_message = new Promise (function(res, rej) {
    var message = database.ref("/Class/Secondary/Esp3").once("value").then(function(snapshot){
    ...
    $("#bsubmit").click(
        function(e){
            ...
            if($("#firstanswer1")[0].checked == true){
                $("#alert1").append("<h4 style='color: #E9E603;'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='espsecondclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong></h4>");
           ...
           if($("#secondanswer1")[0].checked == true){
                $("#alert2").append("<h4 style='color: #E9E603;'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='espsecondclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
            ...
            if($("#thirdanswer1")[0].checked == true){
                ...
                $("#alert3").append("<h4 style='color: #E9E603;'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='espsecondclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
