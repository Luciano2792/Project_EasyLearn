var get_message = new Promise (function(res, rej) {
    var message = database.ref("/Class/Prep/Math3/").once("value").then(function(snapshot){
        var data = snapshot.val();

		$('#title1').text(data.Title);
		$("#subtitle1").text(data.Subtitle);
		$("#subtitle").text(data.Prep);
    ...
    $("#bsubmit").click(
        function(e){
            ...
            if($("#firstanswer1")[0].checked == true){
                $("#alert1").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='maththirdclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong></h4>");
           ...
           if($("#firstanswer2")[0].checked == true){
                ...
                $("#alert2").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='maththirdclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
            ...
            if($("#firstanswer3")[0].checked == true){
                $("#alert3").append("<h4 style='color: rgb(221, 6, 6);'><strong> Lo siento, la respuesta ha sido incorrecta. <a href='maththirdclass1.html'>Repasa los conceptos</a> e intentalo de nuevo</strong><h4>");
